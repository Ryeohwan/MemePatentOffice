...
검색 결과가 없을 시에는 랜덤으로 여러 개의 밈을 추천해준다.
무한스크롤로 사용자에게 편의성을 제공했다.
...
밈 등록 시에 db 에서의  title 중복검사 와 AZURE 유해성 검사 진행을 진행합니다
...
내가 소유한 밈와 경매 목록을 확인할 수 있고 회원 정보에서 내가 쓴 댓글과 좋아요, 거래내역을 확인하고 내가 소유한 밈으로 프로필 수정이 가능하다.


## 7. 알림 -> 빨간 점 + 클릭해서 댓글 이동
![알림](https://user-images.githubusercontent.com/73810834/230759480-55d43f20-a805-4fd8-9f70-21b1cbfac844.gif)
알림받기 설정한 NFT의 알림을 받아볼 수 있고 NFT의 상세화면으로 이동이 가능하다. 내가 소유한 NFT에 댓글이 달렸을 때 알림을 받을 수 있고 작성자와 내 NFT 화면으로 이동 가능하다.

## 8. 회원 정보 수정
![회원 정보 수정](https://user-images.githubusercontent.com/73810834/230759698-55f2d992-fb9d-489a-9587-8c890bc15a24.gif)

사용자가 소유하고 있는 NFT를 사용하여 프로필로 설정할 수 있으며 닉네임도 중복검사 후 수정이 가능하다.

## 9. 경매 등록
![경매 등록](https://user-images.githubusercontent.com/73810834/230757821-9de0de94-3f94-44a9-9bac-1341d1408e21.gif)
소유하고 있는 NFT를 경매에 등록할 수 있고, 현재 진행중인 경매를 인기순, 최신순으로 정렬하여 확인할 수 있다.
