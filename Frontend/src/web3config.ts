...
export const saleMemeTokenAddress = "0x3d8157231C6B74f496aF324520c3071748Ab1347";
export const mintMemeTokenAddress = "0xB521891Bd5966614625368ec8B11079Ae46F3d2C";
...
export const memeOwnerAccess = async () => {
	...
	console.log("mintMemeToken encoded ABI", data);

    // console.log("아놔", mintMemeTokenContract.events.Transfer.returnValues.tokenId)
